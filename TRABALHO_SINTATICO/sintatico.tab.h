...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    L_SQUARE_BRACKET = 264,        /* L_SQUARE_BRACKET  */
    R_SQUARE_BRACKET = 265,        /* R_SQUARE_BRACKET  */
    ASSIGN = 266,                  /* ASSIGN  */
    ...
    INC = 305,                     /* INC  */
    DEC = 306,                     /* DEC  */
    BITWISE_COMP = 307,            /* BITWISE_COMP  */
    NOT = 308,                     /* NOT  */
    CHARACTER = 309,               /* CHARACTER  */
    NUM_INTEGER = 310,             /* NUM_INTEGER  */
    NUM_HEXA = 311,                /* NUM_HEXA  */
    NUM_OCTAL = 312,               /* NUM_OCTAL  */
    OTHER = 313                    /* OTHER  */
  };
